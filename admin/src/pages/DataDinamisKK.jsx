...
const DataDinamisKK = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/dinamis/kategorilistkk/${kategori}`);
  ...
  const handleDelete = async () => {
    ...
    setIsLoading(true);
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL}/dinamis/deletedatadinamiskk/${idToDelete}`);
